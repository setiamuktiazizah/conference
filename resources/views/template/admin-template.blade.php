...
<head>
  ...
  {{-- CSS --}}
  <link rel="stylesheet" href="{{asset('css/admin-template-style.css')}}">
</head>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #FD853A">
    <!-- Brand Logo -->
    <a href="index3.html" class="brand-link">
      {{-- <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"> --}}
      <img src="/images/logo webdemia biru.png" alt="Webdemia" style="width: 174px; height: 60px">
